...
public class BagStoreTest {
    ...
    public void should_be_return_bag_when_given_key() {
        ...
        Bag fromBagStoreBag = lockerWall.pop(ticket);
        Assert.assertSame(bag, fromBagStoreBag);
    }
    ...
    @Test
    public void should_be_the_same_with_capacity_when_init_wall(){
        int emptyLockersNum = lockerWall.getEmptyLockersNum();
        Assert.assertEquals(5, emptyLockersNum);
    }

    @Test
    public void should_be_the_4_with_capacity_when_store_one_bag_to_5_locker() {
        lockerWall.put(new Bag());
        int emptyLockersNum = lockerWall.getEmptyLockersNum();
        Assert.assertEquals(4, emptyLockersNum);
    }
